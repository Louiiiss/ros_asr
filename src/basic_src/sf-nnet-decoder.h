 ...
 */
class SFNnetDecoder : public SFGenericDecoder {
public:
	SFNnetDecoder(SFController *controller, SFNnetConfig* root_config, const char* keyphrase);
...
protected:
	...
	SingleUtteranceNnet2Decoder* nnet_decoder;
